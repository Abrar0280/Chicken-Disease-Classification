...
class PrepareBaseModel:
    ...
    def get_base_model(self):
        ...
        weights_url = "https://storage.googleapis.com/tensorflow/keras-applications/vgg16/vgg16_weights_tf_dim_ordering_tf_kernels_notop.h5"
        weights_file = "vgg16_weights_tf_dim_ordering_tf_kernels_notop.h5"

        if not os.path.exists(weights_file):
            with urllib.request.urlopen(weights_url, context=ssl_context) as response, open(weights_file, 'wb') as out_file:
